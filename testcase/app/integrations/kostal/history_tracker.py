...
class PikoHistoryTracker:
    ...
    def update_metrics(self, daily_energy):
        ...
        if last_update:
            ...
            if now.day != last_update_dt.day:
                ...
                history.power_hour = 0.0  # KORREKTUR: Ein neuer Tag nullt IMMER auch die Stunde!
                is_new_day = True
        ...
        # Delta auf historische Intervalle direkt aufaddieren
        ...
        # Aktuellen Wert und Zeitstempel für den nächsten Durchlauf fixieren
