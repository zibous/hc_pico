# -*- coding: utf-8 -*-
"""
Pydantic-Modelle für die Kostal-Piko-Integration.

Typsichere Datenstrukturen für Generator-Daten, PV-Konfiguration,
Modellparameter und Historien-Metriken.
"""
...
class AdvancedAnalytics(BaseModel):
    """Typsichere Struktur für die erweiterten Backend-Berechnungen."""
...
class GeneratorData(BaseModel):
    ...
    # DC-Spannungen der Strings
    string1_voltage: float = Field(default=0.0)
    string2_voltage: float = Field(default=0.0)
    string3_voltage: float = Field(default=0.0)
...
class PanelConfig(BaseModel):
    ...
    tilt: float = Field(default=45.0)
    azimuth: float = Field(default=90.0)
