# -*- coding: utf-8 -*-
"""
PikoCalculator — Statische Berechnungen für den Kostal Piko Wechselrichter.

Enthält:
- Leistungsfaktor-Berechnung (cos phi)
- Laufzeit seit Installation
- Erweiterte Analysen (Effizienz, Blindleistung, Symmetrie, CO2)
- Einspeisedauer aus SQLite
"""
...
class PikoCalculator:
    @staticmethod
    def calculate_power_factors(gen_model: GeneratorData) -> GeneratorData:
        """Berechnet AC-Leistungsfaktoren dynamisch per Schleife."""
    ...
    @staticmethod
    def calculate_running_time(installed_date) -> dict:
        """Berechnet die exakte Laufzeit seit Installation."""
    ...
    @staticmethod
    def calculate_advanced_analytics(gen_model: GeneratorData, today_kwh: float) -> dict:
        """
        Berechnet erweiterte Analysewerte basierend auf den Pydantic-Feldern
        des GeneratorData-Modells.
        """
        # AC-Gesamtleistung aus den Phasen-Watt-Feldern
        ...
        # DC-Leistung über Wirkungsgrad-Standard schätzen
        total_dc = p_ac / 0.96 if p_ac > 50 else 0.0
        efficiency = 96.0 if p_ac > 50 else 0.0

        # Schein- und Blindleistung über den dynamischen Powerfactor
        ...
        # Netz-Symmetrie (Spannungsunsymmetrie)
        ...
        # CO2-Vermeidung & Bäume (0.380 kg/kWh, 1 Baum = 12.5 kg/Jahr)
        CO2_FACTOR = 0.380
        ...
        # Himmel-Klarheitsindex (basierend auf 5.0 kW Peak-Nennleistung)
